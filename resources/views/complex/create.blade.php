...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Complex/</span> Create</h4>
...
<div class="row">
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form method="post" action="{{route('complex.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="complex_name" name="name" placeholder="Complex Name" required />
        </div>
        <div class="mb-3">
          <label class="form-label" for="year-build">Year Built</label>
          <input type="text" class="form-control" id="year-build" name="year_built" placeholder="Year Built" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="Architect">Architect</label>
          <input type="text" class="form-control" id="Architect" name="architect" placeholder="Architect" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="Constructor">Constructor</label>
          <input type="text" class="form-control" id="Constructor" name="constructor" placeholder="Constructor" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="number-units">Number of Units</label>
          <input type="number" class="form-control" id="number-units" name="number_units" placeholder="Number of Units" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="floors">Number of Floors</label>
          <input type="number" class="form-control" id="floors" name="number_floors" placeholder="Number of Floors" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="body_manager" id="body_manager" placeholder="Body Corporate Manager" />
        </div>
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="file" name="attached[]" accept=".pdf, .doc, .xls, docx" multiple>
        </div>
