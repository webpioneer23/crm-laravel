...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Appraisal/</span> Edit</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <select class="form-select" name="land_size_unit" id="land_size_unit">
                    ...
                    <option value="{{$land_size_unit_option}}" {{$land_size_unit_option == $appraisal->property?->land_size_unit ? 'selected' : ''}}>{{$land_size_unit_option}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
