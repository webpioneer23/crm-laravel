...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Listing Portal/</span> Create</h4>

<!-- Basic Layout & Basic with Icons -->
<div class="row">
  <div class="card mb-4">
    <div class="card-body">
      <form method="post" action="{{route('listingPortal.store')}}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="base_url" placeholder="Tag Name" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="basic-default-fullname">API Key</label>
          <input type="text" class="form-control" name="key" placeholder="Tag Name" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="basic-default-fullname">Office Id</label>
          <input type="text" class="form-control" name="office_id" placeholder="Tag Name" />
        </div>
