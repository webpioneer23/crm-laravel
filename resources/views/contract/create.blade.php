...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Contract/</span> Create</h4>
    ...
    <div class="card-body">
      <form method="post" action="{{route('contract.store')}}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <select id="listing_id" class="select2 form-select form-select-lg" name="listing_id" data-allow-clear="true" required>
              <option value="">Select</option>
              @foreach($listings as $listing)
              <option value="{{$listing->id}}"> {{$listing->address?->unit_number ? $listing->address->unit_number."/" : ""}}{{$listing->address->street}}, {{$listing->address->city}} </option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="purchaser_name" id="purchaser_name" class="form-control" placeholder="Purchaser Name" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="price">Price (EX GST)</label>
          <div class="col-sm-10">
            <div class="input-group">
              <input type="text" name="price" id="price" class="form-control numeral-mask" aria-label="">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="date" name="contract_accepted_date" class="form-control" placeholder="Contract Accepted Date" />
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="unconditional_date">Unconditional Date</label>
          <div class="col-sm-10">
            <input type="date" name="unconditional_date" class="form-control" placeholder="Unconditional Date" />
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="settlement_date">Settlement Date</label>
          <div class="col-sm-10">
            <input type="date" name="settlement_date" class="form-control" placeholder="Settlement Date" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="date" name="deposit_due_date" class="form-control" placeholder="Deposit Due Date" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="date" name="deposit_received_date" class="form-control" placeholder="Deposit Received Date" />
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              <input type="text" name="commission" id="commission" class="form-control numeral-mask" aria-label="">
              <span class="input-group-text">$</span>
            </div>
          </div>
        </div>
