<form method="post" action="{{route('address.update', $address->id)}}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="bedroom" class="select2 form-select" id="bedroom">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->bedroom == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="bathroom" class="select2 form-select" id="bathroom">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->bathroom == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="ensuite" class="select2 form-select" id="ensuite">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->ensuite == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="toilet" class="select2 form-select" id="toilet">
                ...
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->toilet == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="garage" class="select2 form-select" id="garage">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->garage == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="carport" class="select2 form-select" id="carport">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->carport == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="open_car" class="select2 form-select" id="open_car">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->open_car == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="living" class="select2 form-select" id="living">
                @for ($i = 0; $i < 51; $i++) <option value="{{$i}}" {{$address->property?->living == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-md-6">
                    <input type="number" class="form-control" name="house_size" value="{{$address->property?->house_size}}" step="0.01">
                </div>
                <div class="col-md-6">
                    <select class="form-select" name="house_size_unit">
                        @foreach($house_size_unit_options as $house_size_option)
                        <option value="{{$house_size_option}}" {{$house_size_option == $address->property?->house_size_unit ? 'selected' : ''}}>{{$house_size_option}}</option>
                        @endforeach
                    </select>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-md-6">
                    <input type="number" class="form-control" name="land_size" value="{{$address->property?->land_size}}" step="0.01">
                </div>
                <div class="col-md-6">
                    <select class="form-select" name="land_size_unit">
                        @foreach($land_size_unit_options as $land_size_unit_option)
                        <option value="{{$land_size_unit_option}}" {{$land_size_unit_option == $address->property?->land_size ? 'selected' : ''}}>{{$land_size_unit_option}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <select name="energy_efficiency_rating" class="select2 form-select" id="energy_efficiency_rating">
                <option value=" ">-</option>
                @for ($i = 0; $i <= 10; $i=$i + 0.5) <option value="{{$i}}" {{$address->property?->energy_efficiency_rating == $i ? 'selected' : ''}}>{{$i}}</option>
                    @endfor
            </select>
        </div>
